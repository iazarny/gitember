...
/**
 * TC-003 — stage a new file via the working-copy checkbox column and commit it through
 * {@code CommitDialog}, then verify the commit lands in the real on-disk repo.
 *
 * <p>See {@code FirstCommitUiTest} for the zero-commit (unborn HEAD) variant of this flow.
 */
class StageUnstageUiTest extends SwingUiTestBase {

    @Test
    void stageAndCommit_createsCommitVisibleInLog() throws Exception {
