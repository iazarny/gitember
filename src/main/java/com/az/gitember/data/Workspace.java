...
/**
 * A named group of projects/repositories. A {@link Settings} instance may hold several
 * workspaces, allowing the user to keep unrelated sets of repositories separate
...
public class Workspace implements Serializable, Comparable<Workspace> {
    ...
    /** Name of the workspace seeded for settings migrated from the pre-workspace format. */
