...
/**
 * Copysnatched from original VirtualizedScrollPane to have scroll bar from the left side. Sorry, follow SOLID
 * @param <V>
 */
@DefaultProperty("content")
public class VirtualizedOverviewScrollPane<V extends Node & Virtualized> extends Region implements Virtualized {
     ...
     */
    public VirtualizedOverviewScrollPane(
        ...
        hPosEstimate = Val.combine(
                        ...
                        VirtualizedOverviewScrollPane::offsetToScrollbarPosition)
     ...
     */
    public VirtualizedOverviewScrollPane(@NamedArg("content") V content) {
