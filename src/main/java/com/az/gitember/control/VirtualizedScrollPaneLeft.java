...
public class VirtualizedScrollPaneLeft<V extends Node & Virtualized> extends Region implements Virtualized {
     ...
     */
    public VirtualizedScrollPaneLeft(
        ...
        hPosEstimate = Val.combine(
                        ...
                        VirtualizedScrollPaneLeft::offsetToScrollbarPosition)
     ...
     */
    public VirtualizedScrollPaneLeft(@NamedArg("content") V content) {
