package com.az.gitember.module.history.renderer;
...
public class HistoryPlotCommitRenderer extends AbstractPlotRenderer<PlotLane, Color>  {
    ...
    private String getText(PlotCommit<PlotLane> plotCommit) {
    ...
    public void render(GraphicsContext graphicsContext, PlotCommit<PlotLane> plotCommit, int height) {
