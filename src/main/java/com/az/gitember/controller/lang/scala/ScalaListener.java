...
public interface ScalaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ScalaParser#args}.
	 * @param ctx the parse tree
	 */
	void enterArgs(ScalaParser.ArgsContext ctx);
	/**
	 * Exit a parse tree produced by {@link ScalaParser#args}.
	 * @param ctx the parse tree
	 */
	void exitArgs(ScalaParser.ArgsContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link ScalaParser#guard_}.
	 * @param ctx the parse tree
	 */
	void enterGuard_(ScalaParser.Guard_Context ctx);
	/**
	 * Exit a parse tree produced by {@link ScalaParser#guard_}.
	 * @param ctx the parse tree
	 */
	void exitGuard_(ScalaParser.Guard_Context ctx);
	...
	/**
	 * Enter a parse tree produced by {@link ScalaParser#def_}.
	 * @param ctx the parse tree
	 */
	void enterDef_(ScalaParser.Def_Context ctx);
	/**
	 * Exit a parse tree produced by {@link ScalaParser#def_}.
	 * @param ctx the parse tree
	 */
	void exitDef_(ScalaParser.Def_Context ctx);
